class JCI_Header extends HTMLElement {
    connectedCallback() {
        this.innerHTML = 
        `
    <!-- Navbar -->
    <div class="container-fluid">
      <nav class="navbar navbar-expand navbar-light bg-light">
        <a class="navbar-brand" href="index.html">
          <img src="assets/logo_jci_almelo.svg" width="50" height="50" alt="">
        </a>
...
customElements.define('jci-header', JCI_Header)

class JCI_Footer extends HTMLElement {
    connectedCallback() {
        this.innerHTML = 
        `
    ...
    <div class="container">
      <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
        <div class="col-md-4 d-flex align-items-center">
          ...
          <span class="mb-3 mb-md-0 text-muted">© 2024 JCI Almelo</span>
        </div>
...
customElements.define('jci-footer', JCI_Footer)